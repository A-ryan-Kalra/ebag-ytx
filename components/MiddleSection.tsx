...
function MiddleSection() {
  return (
    <div className="my-32 flex gap-5 flex-col items-center justify-center">
      <h1 className={`text-4xl ${inter.className}`}>
        Act Fast, Save Big! Offers
      </h1>
      <h1 className={`${inter1.className} text-2xl w-1/3 text-center`}>
        Dress to Thrill, Pay Half the Bill, 50% Off Men's & Women's Clothing!
      </h1>
      <div className="flex gap-5 w-full items-center justify-center">
        <Link
          href={"/"}
          className="bg-black shadow-xl rounded-md  hover:bg-white hover:text-black duration-200 ease-in-out hover:border-2 border-2 border-black  w-[150px] py-2 px-4 text-white"
        >
